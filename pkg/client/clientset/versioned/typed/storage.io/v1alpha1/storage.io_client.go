...
import (
	...
	"github.com/tommenx/storage/pkg/client/clientset/versioned/scheme"
...
// StorageV1alpha1Client is used to interact with features provided by the storage.io group.
type StorageV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StorageV1alpha1Client) StorageLabels(namespace string) StorageLabelInterface {
	return newStorageLabels(c, namespace)
}
